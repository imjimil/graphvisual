...
const App = () => {
  ...
  return (
    <div>
      ...
      {showGraph && algorithm === "firstfit" && <FirstFit numVertices={numVertices} key={key} valueOfK={valueOfK} />}
      {showGraph && algorithm === "CBIP" && <CBIP numVertices={numVertices} key={key} valueOfK={valueOfK} />}
